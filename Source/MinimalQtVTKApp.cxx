...
namespace {
    ...
    public:
        ...
        virtual void OnLeftButtonDown() override
        {
            ...
            if (this->Drawflag) {
                // Draw the line
                if (this->Points->GetNumberOfPoints() > 2 && this->ShapeName == "Line" && mode_line != "Enter points")
                {
                    DrawLine(this->Points);
                }
                else if (this->Points->GetNumberOfPoints() > 2 && this->ShapeName == "Line" && mode_line == "Enter points")
                {
